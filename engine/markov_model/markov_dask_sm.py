...
if __name__ == "__main__":
    fname = '~/Dropbox/PhD/htm_models_adelaide/engine/markov_model/115_2_sm_flow.pkl'
    args = []
    # print(do_model((fname, 2, SCHEME_MEAN)))
    ...
    print(tabulate(results, headers=['Order', 'Time', 'Rows', 'Missing', 'Missing %', 'Scheme', 'RMSE']))
